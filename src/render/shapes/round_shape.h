...
public:
    RoundShape(const std::size_t size = 0, const RenderingMode renderingMode = GL_TRIANGLES);
    ...
    virtual const std::size_t GetVertexesCount() const override { return this->vertexCount; }

    virtual const std::size_t GetTrianglesCount() const override { return this->triangleCount; }

    virtual const std::size_t GetLinesCount() const override { return this->linesCount; }

    virtual const std::size_t GetIndexesCount() const override { return this->indexCount; }

    virtual const VertexPositionData* GetPositions() const override { return this->vertexPositionData.data(); }

    virtual const VertexIndexData* GetIndexes() const override { return this->vertexIndexData.data(); }

    virtual const VertexNormalData* GetNormals() const override { return this->vertexNormalData.data(); }
