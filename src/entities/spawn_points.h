...
{
public:
    SpawnPoints(const ecs::EntityId&   entityId,
                ecs::ComponentManager* componentManager);
    ~SpawnPoints() override = default;

    void SetTankTypeSpawnComponents(
        std::vector<
            std::pair<TankTypeComponent*, std::vector<SpawnPositionComponent*>>>
            tankTypeSpawnComponents)
    {
    ...
    const auto& GetTankTypeSpawnComponents() const
    {
        return this->tankTypeSpawnComponents;
    }
